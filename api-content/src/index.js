...
// ==========================================
// ENDPOINTS GESTIONE MAZZI DI FLASHCARDS
// ==========================================

// 1. Recupero Mazzi (Protetto)
app.get('/api/v1/flashcards/decks', validateIdentity, async (req, res) => {
  const username = req.user.username;
  try {
    const result = await pool.query(
...
app.post('/api/v1/flashcards/decks', validateIdentity, async (req, res) => {
...
app.put('/api/v1/flashcards/decks/:id', validateIdentity, async (req, res) => {
...
app.delete('/api/v1/flashcards/decks/:id', validateIdentity, async (req, res) => {
  const deckId = parseInt(req.params.id);
  const username = req.user.username;
...
// ==========================================
// ENDPOINTS GESTIONE FLASHCARDS
// ==========================================

// 5. Recupero Flashcard di un Mazzo (Protetto)
app.get('/api/v1/flashcards/decks/:id/cards', validateIdentity, async (req, res) => {
  const deckId = parseInt(req.params.id);
  const username = req.user.username;
...
app.post('/api/v1/flashcards/decks/:id/cards', validateIdentity, async (req, res) => {
  const deckId = parseInt(req.params.id);
...
app.put('/api/v1/flashcards/cards/:id', validateIdentity, async (req, res) => {
...
app.delete('/api/v1/flashcards/cards/:id', validateIdentity, async (req, res) => {
  const cardId = parseInt(req.params.id);
  const username = req.user.username;
